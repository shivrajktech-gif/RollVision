...
MIDDLEWARE = [
    ...
    # Custom security middleware - TEMPORARILY DISABLED
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'debug': DEBUG,  # Disable template caching in development
        },
    },
]
...
if not DEBUG:
    ...
    # Development settings - allow login without HTTPS
    SESSION_COOKIE_SECURE = False
    CSRF_COOKIE_SECURE = False
    CSRF_COOKIE_HTTPONLY = False  # Allow JavaScript to read CSRF cookie in dev
    CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1:8000', 'http://localhost:8000']
    CSRF_USE_SESSIONS = False  # Store CSRF token in cookie, not session
    CSRF_COOKIE_SAMESITE = 'Lax'  # Allow cross-site in dev
...
# CSRF_COOKIE_HTTPONLY moved to conditional block above
